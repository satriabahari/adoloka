    ...
    <div class="max-w-3xl mx-auto px-4 py-12">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <!-- Customer Info -->
                <div class="mb-6">
                    <h2 class="text-lg font-bold text-slate-800 mb-4">Informasi Pemesan</h2>
                    <div class="space-y-2">
                ...
                <div class="border-t border-slate-200 pt-6 mb-6">
                    <h2 class="text-lg font-bold text-slate-800 mb-4">Detail Pesanan</h2>
                    <div class="bg-sky-50 rounded-lg p-4">
                        <div class="flex items-start gap-4">
                            <div class="w-16 h-16 bg-sky-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    @if ($order->service->category->slug === 'branding')
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex-1">
                                <h3 class="font-bold text-slate-800 mb-1">{{ $order->service->name }}</h3>
                                <p class="text-sm text-slate-600 mb-2">{{ $order->service->description }}</p>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-slate-600">Jumlah: {{ $order->quantity }}x</span>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-700">Pesanan Anda sedang diproses. Kami akan menghubungi
                                    Anda
                                    melalui WhatsApp untuk langkah selanjutnya.</p>
                                @if ($order->paid_at)
                                    <p class="text-xs text-green-600 mt-2">Dibayar pada:
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-yellow-700">Silakan selesaikan pembayaran Anda untuk melanjutkan
                                    proses pesanan.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    @if ($order->service->consultation_link)
                        <a href="{{ $order->service->consultation_link }}" target="_blank"
